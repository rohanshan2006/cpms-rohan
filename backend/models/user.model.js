...
const UserSchema = new mongoose.Schema({
  ...
  studentProfile: {
    ...
    department: { type: String, enum: ['Computer', 'Civil', 'ECS', 'AIDS', 'Mechanical', 'Computer Science', 'CSDS', 'Information Technology', 'IT'] },
    ...
    appliedJobs: [
      {
        ...
        status: { type: String, enum: ['applied', 'interview', 'hired', 'rejected', 'shortlisted', 'oa_cleared', 'interview_scheduled', 'selected'], default: 'applied' },
        package: { type: Number },
