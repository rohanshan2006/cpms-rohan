    ...
    >
      <div className="text-center mb-12">
        ...
        <p className="text-md md:text-lg max-w-3xl mx-auto text-gray-700 px-3">
          CPMS (College Placement Management System) is a full-stack web application developed by Rohan Shandilya to streamline campus placements, internships, recruitment drives, and placement analytics through role-based dashboards for Students, TPOs, Management, and Administrators.
        </p>
      </div>
