            ...
            <div className="max-sm:text-sm text-base">
                  ...
                  <div className="">
                    <Form className='flex flex-col justify-center items-center gap-3 text-center'>
                      ...
                      <Form.Group controlId="formFile" className="mb-3 text-xl" onChange={handlePhotoChange}>
                        <Form.Label>{data.first_name + " " + data.last_name}</Form.Label>
              ...
              <div className="flex items-center gap-3 mt-4">
                ...
                <Button variant="outline-primary" onClick={() => {
                  ...
                  else if (data.role === 'tpo_admin') navigate('/tpo/dashboard');
                  else if (data.role === 'management_admin') navigate('/management/dashboard');
                  else navigate(-1);
                }}>
                  Home
                </Button>
