...
```bash
git clone https://github.com/rohanshandilya/college-placement-management-system.git
...
The system automatically seeds default accounts on startup if they do not exist. Use the following credentials to access each role's portal:

### Super Admin
- **Login URL**: [http://localhost:5173/admin](http://localhost:5173/admin)
- **Email**: `admin@cpms.com`
- **Password**: `Admin@123`

### TPO (Training & Placement Officer)
- **Login URL**: [http://localhost:5173/tpo/login](http://localhost:5173/tpo/login)
- **Email**: `tpo@cpms.com`
- **Password**: `TPO@123`

### Management
- **Login URL**: [http://localhost:5173/management/login](http://localhost:5173/management/login)
...
GitHub: https://github.com/rohanshan2006
